...
image_files = ['./results/KDE_generation_cifar10/kde_sampling_original_cifar10_{}.png'.format(i) for i in range(0, 8)] + ['./results/KDE_generation_cifar10/kde_sampling_sample_cifar10_{}.png'.format(i) for i in range(0, 8)] + \
                ['./results/fid-tmp-optim-early-stop-5/000000/00002{}.png'.format(i) for i in range(0, 8)] # Adjust the range and file names as necessary
...
# Save the collage
output_path = './results/collected_visualizations_early_stop.png'
